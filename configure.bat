@echo off
rem Batch file for build firmware of SECU-3 project
rem Created by Alexey A. Shabelnikov, Kiev 17 July 2011. 
rem Note: It requires IAR compiler and linker
