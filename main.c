...
{
  //реализация функции ЭПХХ. Если заслонка карбюратора закрыта и [ниж.порог] < frq < [верх.порог],то производится
  ...
  //--инверсия концевика карбюратора если необходимо, включение/выключение клапана ЭПХХ
   ...
   d->ephh_valve=PORTB_Bit0 = ((!d->sens.carb)&&((d->sens.frequen > d->param.ephh_lot)&&
