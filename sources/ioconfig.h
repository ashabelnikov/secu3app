...
#define IOP_PWM1         79     //!< PWM1            (output)
#define IOP_PWM2         80     //!< PWM2            (output)
#define IOP_FL_CONS      81     //!< FL_CONS         (output)
#define IOP_AUTO_I       82     //!< AUTO_I          (input)
...
#define IOP_PWM1         78     //!< PWM1            (output)
#define IOP_PWM2         79     //!< PWM2            (output)
#define IOP_FL_CONS      80     //!< FL_CONS         (output)
#define IOP_AUTO_I       81     //!< AUTO_I          (input)
