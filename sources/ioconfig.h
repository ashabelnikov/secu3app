...
#define IOP_FL_PUMP      23     //!< FL_PUMP         (output)
#define IOP_HALL_OUT     24     //!< HALL_OUT        (output)
#define IOP_STROBE       25     //!< STROBE          (output)
#define IOP_PWRRELAY     26     //!< PWRRELAY        (output)
#define IOP_IGN          27     //!< IGN             (input)
#define IOP_IGN_OUT7     28     //!< IGN_OUT7        (output)
#define IOP_IGN_OUT8     29     //!< IGN_OUT8        (output)
#define IOP_BC_INPUT     30     //!< BC_INPUT        (input)
#define IOP_SM_DIR       31     //!< SM_DIR          (output)
#define IOP_SM_STP       32     //!< SM_STP          (output)
#define IOP_MAPSEL0      33     //!< MAPSEL0         (input)
#define IOP_SPDSENS      34     //!< SPD_SENS        (input)
#define IOP_INTK_HEAT    35     //!< INTK_HEAT       (output)
#define IOP_LAMBDA       36     //!< LAMBDA          (input)
#define IOP_AIR_TEMP     37     //!< AIR_TEMP        (input)
#define IOP_INJ_OUT0     38     //!< INJ_OUT0        (output)
#define IOP_UNI_OUT0     39     //!< UNI_OUT0        (output)
#define IOP_UNI_OUT1     40     //!< UNI_OUT1        (output)
#define IOP_UNI_OUT2     41     //!< UNI_OUT2        (output)
#define IOP_RESERVED8    42     //!< reserved plug   ()
#define IOP_RESERVED9    43     //!< reserved plug   ()
#define IOP_RESERVED10   44     //!< reserved plug   ()
#define IOP_RESERVED11   45     //!< reserved plug   ()
#define IOP_RESERVED12   46     //!< reserved plug   ()
#define IOP_RESERVED13   47     //!< reserved plug   ()
#define IOP_RESERVED14   48     //!< reserved plug   ()
#define IOP_RESERVED15   49     //!< reserved plug   ()
