...
#define IOP_UNI_OUT0     38     //!< UNI_OUT0        (output)
#define IOP_UNI_OUT1     39     //!< UNI_OUT1        (output)
#define IOP_UNI_OUT2     40     //!< UNI_OUT2        (output)
#define IOP_INJ_OUT0     41     //!< INJ_OUT0        (output)
