...
#define AE_TPS_B(v) ROUND(((v)*2.0) / 10.0)
/**For filling values of the AE's TPS lookup table*/
#define AE_TPS_V(v) ROUND((((v)/100.0)*128.0))
 ...
 /**Fill data residing in code area, has floating address. Address is identified by a unique signature*/
 {
  ...
  /**I/O remapping. Match slots and plugs for default configuration*/
  {
   ...
   {_FNC(iocfg_i_ign_out1), _FNC(iocfg_i_ign_out2), _FNC(iocfg_i_ign_out3), _FNC(iocfg_i_ign_out4),
    ...
    0,0,0,0,0,0,0                  //<-- zero means that these slots are not implemented in this firmware
   ...
   {_FNC(iocfg_i_ign_out1), _FNC(iocfg_i_ign_out2), _FNC(iocfg_i_ign_out3), _FNC(iocfg_i_ign_out4),
    ...
    _FNC(iocfg_i_gas_v), _FNC_S_SECU3T(iocfg_i_ref_s), 0, 0, 0, 0, 0, 0, 0, //<-- mapped to slots by default
   ...
   {_FNC(iocfg_s_ign_out1), _FNC(iocfg_s_ign_out2), _FNC(iocfg_s_ign_out3), _FNC(iocfg_s_ign_out4),
    ...
    _FNC(iocfg_g_gas_v), _FNC_G_SECU3T(iocfg_g_ref_s), 0, 0, 0, 0, 0, 0, 0, //<-- mapped to slots by default
    _FNC(iocfg_s_stub), _FNC(iocfg_s_stub), _FNC(iocfg_s_stub), _FNC(iocfg_s_stub),
 ...
 {
  {
   ...
   {0x14,0x14,0x14,0x0A,0x0A,0x0A,0x0A,0x14,0x23,0x32,0x37,0x37,0x37,0x37,0x37,0x37},  //ХХ карта
   {
   ...
   /**Fill bins of the AE's TPS lookup table, range is 0...1000% / 1s */
   {
    AE_TPS_B(20.0), AE_TPS_B(40.0), AE_TPS_B(160.0), AE_TPS_B(600.0)
   },
   /**Fill values of the AE's TPS lookup table, range is 0...199% */
   {
    AE_TPS_V(1.0), AE_TPS_V(2.0), AE_TPS_V(6.0), AE_TPS_V(15.0)
   },
